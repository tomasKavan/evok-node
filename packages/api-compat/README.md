...
Owns **the** projection table, derived from driver introspection rather than hand-maintained (ADR-0003).
Two vocabularies meet here and nowhere else (RC-24). Requires **at most one** onboard driver — zero is
...
when an administrator lists it (ADR-0009).
