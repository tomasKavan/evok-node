...
**Updated:** 2026-08-16 · **Milestone:** [M3 — development documentation](roadmap.md) ·
**Version:** unreleased
...
**M3 — development documentation.** [`docs/dev/`](../dev/README.md), files `00`–`20`, currently
scaffolded as memos with no content. Written from the research above, settled by discussion as it
goes. It also has to produce three things beyond itself: the architecture it commits to, the ADR set
that gets re-locked, and *What 1.0 is*.
