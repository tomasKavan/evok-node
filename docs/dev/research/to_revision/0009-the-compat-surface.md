...
- **Status:** Proposal, **not in force** — the set was dissolved 2026-08-18, see [README](README.md). Was: Accepted — the privileged surface's own authentication deferred; handling of evok's nginx site pending the capture trip.
- **Date:** 2026-08-12
