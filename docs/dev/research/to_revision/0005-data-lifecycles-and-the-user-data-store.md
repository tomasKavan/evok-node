...
- **Status:** Proposal, **not in force** — the set was dissolved 2026-08-18, see [README](README.md). Was: Accepted — `node:sqlite` stability to confirm against the pinned Node 24 minor.
- **Date:** 2026-08-10
