...
| [`11-roadmap.md`](11-roadmap.md) | Sequencing **rationale** — why the phases are ordered as they are, and what agent-driven development demands. **Superseded as a working document by [`docs/plan/`](../plan/README.md)**, which is authoritative for what to do next. |
